 ...
 * under the License.
 */
define(['lodash', 'log', './node', './variable-definition'], function (_, log, ASTNode, VariableDefinition) {
     ...
     */
    var ParameterDefinition = function (args) {
        VariableDefinition.call(this, args);
    ...
    ParameterDefinition.prototype = Object.create(VariableDefinition.prototype);
     ...
     * @param options
     */
    ParameterDefinition.prototype.setName = function (name, options) {
        //name can be null for parameter definitions (e.g. : named and unnamed return types)
        this.setAttribute('_name', name, options);
    };

    ParameterDefinition.prototype.getParameterDefinitionAsString = function() {
        var argAsString = "";
    ...
    ParameterDefinition.prototype.addAnnotation = function () {
        var annotation = this.getFactory().createAnnotation();
        this.addChild(annotation);
    };

    ParameterDefinition.prototype.initFromJson = function (jsonNode) {
